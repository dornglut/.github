...
```text
Dornglut
├── Runen framework family
├── Applications and creative tools
└── Engineering model
```
...
- [RunenSpatial](https://github.com/dornglut/runen-spatial) — standalone framework for neutral spatial mechanics
...
- [Werkstatt](https://github.com/dornglut/werkstatt) — application and bounded product pilot for repository-aware development work
...
<!-- atomic-publication canary; do not merge -->
